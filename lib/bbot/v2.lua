...
do
	Library = {
		Open = true;
		Accent = Color3.fromRGB(130, 70, 165);
		Pages = {};
		Sections = {};
		Flags = {};
		UnNamedFlags = 0;
	...
	do
		function Library:NewPicker(name, default, defaultalpha, parent, count, flag, callback)
			...
			Library:Connection(game:GetService("UserInputService").InputBegan, function(Input)
			    if ColorOutline.Visible and (Input.UserInputType == Enum.UserInputType.MouseButton1 or Input.UserInputType == Enum.UserInputType.Touch) then
	...
	do
		...
		function Library:Window(Options)
			...
			-- // Dragging
			Library:SetDraggable(Outline, 0.65)
			Library:Connection(game:GetService("UserInputService").InputBegan, function(Input)
		...
		function Sections:Toggle(Properties)
			...
			function Toggle:Keybind(Properties)
				...
				--
				Library:Connection(game:GetService("UserInputService").InputBegan, function(Input)
					if ModeBox.Visible and (Input.UserInputType == Enum.UserInputType.MouseButton1 and Input.UserInputType == Enum.UserInputType.Touch) then
		...
		function Sections:List(Properties)
			...
			Library:Connection(game:GetService("UserInputService").InputBegan, function(Input)
				if ContentOutline.Visible and Input.UserInputType == Enum.UserInputType.MouseButton1 and Input.UserInputType == Enum.UserInputType.Touch then
