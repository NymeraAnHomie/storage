...
-- Library functions 
    ...
    -- Library element functions
        function Library:Window(properties)
            ...
            function Cfg.ChangeWatermarkIcon(id)
                Items.Watermark:FindFirstChildOfClass("ImageLabel").Image = "rbxassetid://" .. tostring(id)
            end
        ...
        function Library:Configs(window) 
            ...
            window.Tweening = true
            Section:Label({Name = "Menu Bind"}):Keybind({Name = "Menu Bind", Flag = "Menu Bind", ShowInList = false, Callback = function(bool) 
